...
- Resolve advantage and triumph. Commonly used to trigger weapon effect or crit. ([p. 219](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=219))
- Resolve threat and despair. The GM normally spends Threat and Despair from PC checks; players may spend Threat and Despair from NPC checks when the GM allows. ([p. 219](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=219))
- Reduce damage and apply wounds. Wound Value = Damage - Soak.
- Apply crit injury if needed. d100. +10 to the roll for every time the crit is triggered, +10 for every current crit injury. ([p. 231](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=231))

# Spending Advantage and Triumph ([p. 219](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=219))
...
# Spending Threat and Despair ([p. 219](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=219))
...
- <b>1 Despair</b>: Weapon runs out of ammo or energy; upgrade difficulty of an ally's next check, including active character; Tool or weapon becomes damaged ([p. 172](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=172))

# Two-Weapon Combat
- Generally 2 light weapons or one-handed ([p. 224](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=224))
...
- Can be augmented by brawl weapons. Everything is additive except crit rating, use one or another. ([p. 180](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=180))
