...
# Opposed Checks
- Used when a characters actively tries to stop another from succeding. ([p. 31](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=31))
...
# Competitive Checks
- When several people are trying to acomplish the same task at the same time. ([p. 32](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=32))
...
# Assisted Checks
- A player explains how they plan to assist another in a skill check. If it's reasonable, the GM may allow assistance. ([p. 33](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=33))
