# Process
- Determine Initiative by making a Simple (no difficulty) Cool or Vigilance check. (Cool if starting a planned encounter) ([p. 210](https://online.anyflip.com/ziisf/jobq/mobile/index.html#page=211))
...
# Incidentals
- Things that take very little to no effort. ([p. 212](https://online.anyflip.com/ziisf/jobq/mobile/index.html#page=213))
...
- You can perform an extra maneuver at the cost of 2 strain, unless otherwise noted. ([p. 213](https://online.anyflip.com/ziisf/jobq/mobile/index.html#page=214))
...
- <b>Moving</b>: Adjust position one range increment ([p. 221](https://online.anyflip.com/ziisf/jobq/mobile/index.html#page=222)) including disengaging.
...
# Action
- Exchange an action for a maneuver. Cannot perform more than 2 maneuvers. ([p. 216](https://online.anyflip.com/ziisf/jobq/mobile/index.html#page=217))
