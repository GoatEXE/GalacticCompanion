# Prone
- Easier to be hit by melee, +1 boost. ([p. 224](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=224))
- Harder for prone character to attack by melee, +1 setback.
- Harder to hit by ranged, +1 setback.

# Concealed
- Harder to be hit by ranged attacks, harder to be preceived. Easier to sneak. Tiered bonuses below. ([p. 226](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=226))
...
# Staggered
- Unable to perform actions for the specified duration. ([p. 230](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=230))
- If not specified, lasts until the end of the character's next turn.

# Immobilized
- Unable to perform maneuvers for the specified duration. ([p. 230](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=230))
- If not specified, lasts until the end of the character's next turn.

# Disoriented
- Add +1 setback to each skillcheck for the specified duration. ([p. 230](https://online.anyflip.com/ziisf/jobq/mobile/index.html#p=230))
- If not specified, lasts until the end of the character's next turn.